...
public class AdvisorAspect {
    ...
    public void beforeAdvice(JoinPoint jp, com.tony.boot.component.advice.Before before) {
    ...
    public Object aroundAdvice(ProceedingJoinPoint pjp, com.tony.boot.component.advice.Around around) throws Throwable {
    ...
    public Object aroundAdvice(ProceedingJoinPoint pjp, Arounds arounds) throws Throwable {
        Object obj = null;
        for (com.tony.boot.component.advice.Around around: arounds.value()) {
    ...
    public void afterAdvice(JoinPoint jp, com.tony.boot.component.advice.After after) {
    ...
    public void afterReturningAdvice(JoinPoint jp, Object retVal, com.tony.boot.component.advice.AfterReturning afterReturning) {
    ...
    public void afterReturningsAdvice(JoinPoint jp, Object retVal, AfterReturnings afterReturnings) {
        for (com.tony.boot.component.advice.AfterReturning afterReturning : afterReturnings.value()) {
            afterReturningAdvice(jp, retVal, afterReturning);
        }
    }

    @AfterThrowing(value = "@annotation(throwing)", throwing = "ex")
    public void afterThrowingAdvice(JoinPoint jp, Throwable ex, com.tony.boot.component.advice.AfterThrowing throwing) {
